...
The workflow is presented in the Jupyter Notebook on [inputs and simulation](tutorials/pd05simulation.ipynb) (see section _Python script_ or [GitHub](https://github.com/cghiaus/dm4bem_toy_model)) for a synthesis of the workflow).
