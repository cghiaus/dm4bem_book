...
The workflow is presented in the Jupyter Notebook on [inputs and simulation](tutorials/pd05simulation.ipynb) (in which a _[Python script](tutorials/pd05simulation.ipynb#script)_ synthesis the workflow).
