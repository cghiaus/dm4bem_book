...
The workflow is presented in the Jupyter Notebook on [inputs and simulation](tutorials/pd05simulation.ipynb) in which a Pyhton [script](tutorials/pd05simulation.ipynb#script) synthesis the workflow.
